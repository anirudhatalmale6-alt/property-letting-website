...
$routes = [
    ...
    'POST /property/:slug'      => 'site_property_inquiry',
    'GET  /pricing'             => 'site_pricing',
    'GET  /contact'             => 'site_contact',
    'POST /contact'             => 'site_contact_submit',
    'GET  /inquiry-received'    => 'site_inquiry_received',
    'GET  /about'               => 'site_page',
    'GET  /privacy'             => 'site_page',
    'GET  /terms'               => 'site_page',
    'GET  /disclosures'         => 'site_page',
    ...
    'GET  /admin/inquiries'           => 'admin_inquiries',
    'GET  /admin/inquiries/:id'       => 'admin_inquiry_view',
    'POST /admin/inquiries/:id'       => 'admin_inquiry_update',
    'POST /admin/inquiries/:id/delete'=> 'admin_inquiry_delete',
